...
- 각 항목은 반드시 200자 이상으로 작성하세요. 분석은 진단 가능성과 방어기제 수준, 대인 기능, 자아 강도, 성격특성 등을 포함하여 실제 임상에 쓸 수 있을 정도의 깊이로 기술하세요.
...
"""
        ...
        prompt += """
---
보고서는 반드시 위의 지침을 엄격히 지키고, 임상적으로 깊이 있게, 실제 임상 보고서처럼 작성하세요.  

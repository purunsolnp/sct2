...
**1. 검사 개요**
- {patient_name}님, 검사일, 검사 협조도, 응답의 전반적 특성, 검사에서 드러난 주요 심리적 단서 등을 요약해 주세요.
...
**3.1 주요 방어기제 및 성격특성**
**3.2 정신병리학적 고려사항**
{patient_name}님의 응답에서 드러난 방어기제, 성격특성, 정신병리적 위험 신호를 임상적으로 평가해 주세요.
각 소제목별로 반드시 200자 이상으로 작성하세요.
...
**5. 요약 및 예후**
- {patient_name}님의 심리적 특성, 치료 예후, 강점, 재평가 시점 등을 임상적으로 요약해 주세요.
...
"""
        ...
        prompt += """
---
보고서는 반드시 위의 지침을 엄격히 지키고, 임상적으로 깊이 있게, 실제 임상 보고서처럼 작성하세요. 각 항목별로 소제목을 붙이고, {patient_name}님의 실제 응답을 인용해 해석해 주세요. 불필요한 반복이나 단순 요약은 피하고, 임상적 통찰과 치료적 제안을 충분히 포함하세요.
"""
